...
/**
 * Das DataStoreInterface repraesentiert die Schnittstelle zur Datenhaltung.
 * Ueber den DataStore koennen alle im System hinterlegten Fragen und Antworten
 * abgerufen werden. Ausserdem koennen Fragen zur Abstimmung freigeschaltet oder
 * geschlossen werden und einzelne Votings zu einer Abstimmung entgegengenommen
 * werden.
 * 
...
public interface DataStoreInterface {
     ...
     *            die Frage-ID
     * @param status
     *            der zu setzende Status (offen/geschlossen)
     */
     ...
     *            die Frage-ID
     * @param antwortNummer
     *            die Nummer der ausgewaehlten Antwort
     */
     ...
     * @param antwortNummer
     *            Die Antwort zur Frage, um die es geht
     * @param stimmen
